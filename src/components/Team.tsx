...
const Team = () => {
  return <section id="team" className="py-20 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="character-card group">
            <div className="mb-6 relative h-72 overflow-hidden rounded-lg">
              <img src="/lovable-uploads/91f9a8d9-c7f0-4b15-ac36-b1f2ee41c021.png" alt="Sam - AI Engineer" className="w-full h-full object-contain transition-transform group-hover:scale-105 duration-300" />
            </div>
            <h3 className="text-xl font-bold text-maverick-navy">Sam</h3>
            <p className="text-gray-600 mb-4">Lead AI Anayst</p>
          ...
          <div className="character-card group">
            <div className="mb-6 relative h-72 overflow-hidden rounded-lg">
              <img src="/lovable-uploads/1ae48856-a2f2-4726-884c-0b6d75499f8c.png" alt="Morgan - Security Specialist" className="w-full h-full object-contain transition-transform group-hover:scale-105 duration-300" />
            </div>
            <h3 className="text-xl font-bold text-maverick-navy">Dawie</h3>
            <p className="text-gray-600 mb-4">AI Tech Specialist</p>
            <p className="text-gray-700 mb-4">
          ...
          <div className="character-card group">
            <div className="mb-6 relative h-72 overflow-hidden rounded-lg">
              <img src="/lovable-uploads/7bbbed26-c088-4bca-ac2a-6caaad2f929c.png" alt="Jordan - AI Innovation Lead" className="w-full h-full object-contain transition-transform group-hover:scale-105 duration-300" />
            </div>
