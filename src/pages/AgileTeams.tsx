  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow">
        {/* Hero Section */}
        <div className="py-20 bg-gradient-to-br from-newtheme-purple to-newtheme-darkgray text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  <div className="bg-newtheme-purple/10 w-16 h-16 rounded-full flex items-center justify-center mb-4">
                    <svg className="w-8 h-8 text-newtheme-purple" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="py-16 bg-gray-100">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-8">
              <h3 className="text-2xl font-semibold mb-4">Need a Dedicated Team That Feels In-House?</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-3xl mr-4">🔍</span>
                  <h4 className="text-xl font-semibold">Strategic UX + Dev from Day One</h4>
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-xl font-semibold">Built for Speed and Scale</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-3xl mr-4">👥</span>
                  <h4 className="text-xl font-semibold">A Fully Embedded Team</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-3xl mr-4">🌍</span>
                  <h4 className="text-xl font-semibold">Timezone-Aligned, Globally Capable</h4>
                </div>
                <p className="text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-xl font-semibold">Find Talent Fast</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-2xl mr-3">💸</span>
                  <h4 className="text-xl font-semibold">No Recruitment Fees</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-2xl mr-3">📈</span>
                  <h4 className="text-xl font-semibold">Flexible Contracts</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-2xl mr-3">🔄</span>
                  <h4 className="text-xl font-semibold">We Plug Into Your Process</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  <span className="text-2xl mr-3">✅</span>
                  <h4 className="text-xl font-semibold">Vetted and Tested</h4>
                </div>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-xl font-semibold">Our Person, Our Problem</h4>
                </div>
                <p className="text-gray-700">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              <div className="relative">
                <div className="bg-newtheme-purple/10 p-6 rounded-lg">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-newtheme-purple text-white rounded-full text-xl font-bold mb-4">1</div>
                ...
                <div className="hidden lg:block absolute top-1/2 left-full w-8 h-1 bg-newtheme-purple/30 -translate-y-1/2"></div>
              </div>
              
              <div className="relative">
                <div className="bg-newtheme-purple/10 p-6 rounded-lg">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-newtheme-purple text-white rounded-full text-xl font-bold mb-4">2</div>
                  <h4 className="text-xl font-semibold mb-3">
              ...
              <div className="relative">
                <div className="bg-newtheme-purple/10 p-6 rounded-lg">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-newtheme-purple text-white rounded-full text-xl font-bold mb-4">3</div>
                  <h4 className="text-xl font-semibold mb-3">
              ...
              <div>
                <div className="bg-newtheme-purple/10 p-6 rounded-lg">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-newtheme-purple text-white rounded-full text-xl font-bold mb-4">4</div>
                  <h4 className="text-xl font-semibold mb-3">
        ...
        <div className="py-16 bg-gray-100">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="text-xl font-semibold mb-3">Product Strategy & Roadmapping</h4>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="text-xl font-semibold mb-3">UX/UI Design</h4>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="text-xl font-semibold mb-3">API Integration & Platform Engineering</h4>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="text-xl font-semibold mb-3">Ongoing Retainers</h4>
                <p className="text-gray-700">
        ...
        {/* Final CTA Section */}
        <div className="py-16 bg-gradient-to-br from-newtheme-purple to-newtheme-darkgray text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
